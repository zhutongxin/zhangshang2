...
public class DirectoryAddOrModify extends BaseActivity {
	...
	protected void initialSetup(BaseActivity context) {
		...
		if(addOrmodify.equals(Config.ADD)){
		     ...
		     view4=new TextViewEdit(this, "主食名称","",dm);
		     view5=new TextViewEdit(this, "主食类型","",dm);
		    ...
		    view4=new TextViewEdit(this, "主食名称",listdata.get(3),dm);
		    view5=new TextViewEdit(this, "主食类型",listdata.get(4),dm);
