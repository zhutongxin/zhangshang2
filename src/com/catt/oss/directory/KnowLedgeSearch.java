...
public class KnowLedgeSearch extends BaseActivity {
	...
	protected void initialSetup(BaseActivity context) {
		...
		TextViewEdit view1=new TextViewEdit(context, "注册人", null, dm);
		TextViewEdit view2=new TextViewEdit(context, "菜品名称", null, dm);
		TextViewEdit view3=new TextViewEdit(context, "窗口", null, dm);
