...
public class KnowledgeAddOrModify extends BaseActivity {
	...
	protected void initialSetup(BaseActivity context) {
		...
		if(addOrmodify.equals(Config.ADD)){
			 view1=new TextViewEdit(this, "所在食堂","",dm);
		     view2=new TextViewEdit(this, "所在窗口","",dm);
		     view3=new TextViewEdit(this, "厨师名称","",dm);
		     view4=new TextViewEdit(this, "菜品名称","",dm);
		     view5=new TextViewEdit(this, "菜品类型","",dm);
			...
			view1=new TextViewEdit(this, "所在食堂",listdata.get(0),dm);
		    view2=new TextViewEdit(this, "所在窗口",listdata.get(1),dm);
		    view3=new TextViewEdit(this, "厨师名称",listdata.get(2),dm);
		    view4=new TextViewEdit(this, "菜品名称",listdata.get(3),dm);
		    view5=new TextViewEdit(this, "菜品类型",listdata.get(4),dm);
